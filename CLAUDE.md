...
## 古诗文专家团（poetry-expert-panel Skill）

对122篇古诗文逐一做多角度解读的七人专家工作流，用于亲子共读。Skill 名：`poetry-expert-panel`，说"用专家团分析XX诗"即可触发。

工作流：**📜司马迁（看个人）→ 🎭庄子（看天命）→ 🖋️苏轼（品辞章）→ 🌟达哥（亲子共读）→ 📝命题人（考点透视）→ 🔍史官（三道审核）→ 🎨顾恺之（可心入画）**

已完成的专家团页面（每首诗独立文件夹 `YYMMDD_题号_诗名/`）：
- `sessions/2026-06/260601_55_如梦令/` — 第55篇，李清照
- `sessions/2026-06/260608_56_三峡/` — 第56篇，郦道元
- `sessions/2026-06/260609_57_答谢中书书/` — 第57篇，陶弘景
- `sessions/2026-06/260610_58_记承天寺夜游/` — 第58篇，苏轼（1/6）

根目录共享资源：
- `专家团介绍.html` — 七位专家的人物志
- `古诗文知识地图.html` — 122篇按朝代/诗人全量分类
- 122篇目录 PDF、宋朝/北魏疆域底图
